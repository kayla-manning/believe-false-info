...
- interpret the results displayed in the tables
- update README
...
{
  my_packages <- c("tidyverse", "haven", "stargazer")
...
Both the original study and this replication found no evidence that citizens of either party exhibit a greater tendency to endorse false political information. This runs contrary to previous work in the field [source] and supports the conclusion that partisan asymmetries in conspiracy theories largely owe themselves to a greater *supply* of false information rather than a greater *demand*. In extending the results of the analysis, however, a preliminary regression did find some asymmetries in the propensity of particular religious groups to accept false information. This, alongside a study examining the propensity of the different parties to share fake news through social media, warrants future investigation.
...
[^data-source]:The Journal of Politics published the original study. The Harvard Dataverse has replication data and Stata code available at DOI 10.7910/DVN/9ERCTY.
